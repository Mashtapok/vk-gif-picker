...
export const History = () => {
  const { messages, selectedMessages, clearSelection, deleteSelectionMessages } = useMessagesContext();
  ...
  return (
    <div className='history'>
      {selectedMessages.length ? <div className='history__header'>
        <div className='history__selected-messages' onClick={onClearSelection} title='Снять выделение'>
          ...
          <button className='history__selected-messages-remove-btn' type='button'></button>
        </div>
        <div className='history__actions'>
          <button className='history__action-delete' title='Удалить' type='button' onClick={onDelete}>
