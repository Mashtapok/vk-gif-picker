...
export const IconError: React.FC<Props> = ({ className }) => {
  return (
    <Icon width={56} height={56} className={className}>
      <g id="Icons-56/error_outline_56" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
        <g id="error_outline_56">
          ...
          <path
            ...
            id="↳-Icon-Color" fill="currentColor" fillRule="nonzero" />
        </g>
      </g>
    </Icon>
  );
